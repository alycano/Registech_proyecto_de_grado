...
export default function ModalPrestamo({
    ...
    const confirmarPrestamo = () => {
        if (!usuarioDestino) {
            Swal.fire({
                icon: 'warning',
                title: 'Selecciona un beneficiario',
                text: 'Debes elegir el usuario o empleado al que se le asigna el equipo'
            })
            return
        }
    ...
    id_empleado: idEmpleadoSeleccionado || null,
    ...
    enviarCorreo
        ...
        axios.post(API_ROUTES.PRESTAMOS, datosPrestamo)
            .then(() => {
                setEnviando(false)
            ...
            .catch(err => {
                ...
                const msg =
                    ...
                    'Hubo un error al registrar el préstamo'

                Swal.fire({
                    icon: 'error',
                    title: 'Error al confirmar préstamo',
                    text: msg
                })
            })
    }
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body p-0">
                        <div className="row g-0">
                            ...
                            <div
                                className="col-md-5 p-4 border-end"
                            ...
                            >
                                ...
                                <span className="badge estado-disponible mb-3">
                                    {equipo.area}
                                </span>

                                <div
                                    className="card p-3 border mb-3"
                                ...
                                >
                                    ...
                                    <ul className="list-unstyled mb-2">
                                        ...
                                        {getEspecificaciones(equipo).map((spec, i) => (
                                            <li
                                                key={i}
                                                className="text-secondary small py-1 border-bottom"
                                            >
                                                {spec}
                                            </li>
                                        ))}
                                ...
                                <form onSubmit={(e) => e.preventDefault()}>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <select
                                            ...
                                            value={areaPrestamo}
                                            onChange={(e) =>
                                                setAreaPrestamo(e.target.value)
                                            }
                                        >
                                            <option value="">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        {calcularDiasPrestamo() !== null && (
                                            <span className="badge text-bg-primary">
                                                {calcularDiasPrestamo()} día
                                                {calcularDiasPrestamo() !== 1
                                                    ? 's'
                                                    : ''}
                                            </span>
                                        )}
                                    ...
                                    <div className="notificacion-check">
                                        ...
                                        <div className="form-check mb-0">
                                            ...
                                            <label
                                                ...
                                                htmlFor="checkCorreo"
                                            >
Enviar recibo por correo electrónico al destinatario                                            </label>
