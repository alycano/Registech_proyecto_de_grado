  ...
  const [numSeries, setNumSeries] = useState([])
    ...
    const handleSelectEquipo = (serie) => {
        ...
        const crearPrestamo = () => {
            if (numSeries.length === 0 || !usuarioDestino) {
                Swal.fire({
                    icon: 'warning',
    ...
    <div className="mb-3">
        ...
        >
            ...
            {equiposDisponibles
                .filter(e => !numSeries.includes(e.num_serie))
                .map(e => (
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="modal-footer">
                                    ...
                                    disabled={guardando || numSeries.length === 0 || !usuarioDestino}
                                    >
